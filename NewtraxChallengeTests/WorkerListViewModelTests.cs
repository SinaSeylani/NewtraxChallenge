...
namespace NewtraxChallengeTests
{
    [TestFixture]
    public class WorkerListViewModelTests
    {
        ...
        public void LoadWorkers_ShouldRetrieveWorkersFromDatabase()
        {
            ...
            // Assert
            NUnit.Framework.Assert.AreEqual(3, _viewModel.Workers.Count);
            NUnit.Framework.Assert.AreEqual("Worker 1", _viewModel.Workers[0].Name);
            NUnit.Framework.Assert.AreEqual("Worker 2", _viewModel.Workers[1].Name);
            NUnit.Framework.Assert.AreEqual("Worker 3", _viewModel.Workers[2].Name);
        }
